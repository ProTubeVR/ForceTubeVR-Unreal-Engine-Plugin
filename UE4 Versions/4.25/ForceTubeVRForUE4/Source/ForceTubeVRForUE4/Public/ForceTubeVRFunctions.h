...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "ForceTubeVR", meta = (ToolTip = "Only for android packages, open the default android bluetooth settings activity")) static void OpenAndroidBluetoothSettings();
