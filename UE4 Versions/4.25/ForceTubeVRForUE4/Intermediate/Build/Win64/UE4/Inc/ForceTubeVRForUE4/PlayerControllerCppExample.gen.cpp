...
// End Cross Module References
	...
	const UE4CodeGen_Private::FClassParams Z_Construct_UClass_APlayerControllerCppExample_Statics::ClassParams = {
		...
		0,
		0x009002A4u,
		METADATA_PARAMS(Z_Construct_UClass_APlayerControllerCppExample_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_APlayerControllerCppExample_Statics::Class_MetaDataParams))
	};
	...
	IMPLEMENT_CLASS(APlayerControllerCppExample, 1140329186);
	template<> FORCETUBEVRFORUE4_API UClass* StaticClass<APlayerControllerCppExample>()
	{
		return APlayerControllerCppExample::StaticClass();
	}
