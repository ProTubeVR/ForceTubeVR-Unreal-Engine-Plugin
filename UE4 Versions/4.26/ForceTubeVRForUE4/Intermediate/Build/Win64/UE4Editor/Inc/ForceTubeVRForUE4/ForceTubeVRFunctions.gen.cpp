...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_ForceTubeVRForUE4_ForceTubeVRChannel_Hash() { return 1979569934U; }
	...
	DEFINE_FUNCTION(UForceTubeVRFunctions::execOpenAndroidBluetoothSettings)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UForceTubeVRFunctions::execGetBatteryLevel)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
	...
	DEFINE_FUNCTION(UForceTubeVRFunctions::execTempoToKickPower)
	{
	...
	DEFINE_FUNCTION(UForceTubeVRFunctions::execSetActiveResearch)
	{
	...
	DEFINE_FUNCTION(UForceTubeVRFunctions::execShot)
	{
	...
	DEFINE_FUNCTION(UForceTubeVRFunctions::execRumble)
	{
	...
	DEFINE_FUNCTION(UForceTubeVRFunctions::execKick)
	{
		P_GET_PROPERTY(FByteProperty,Z_Param_power);
		P_GET_ENUM(ForceTubeVRChannel,Z_Param_channel);
		P_FINISH;
	...
	DEFINE_FUNCTION(UForceTubeVRFunctions::execInitAsync)
	{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UForceTubeVRFunctions_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UForceTubeVRFunctions_Kick, "Kick" }, // 1315222490
		{ &Z_Construct_UFunction_UForceTubeVRFunctions_OpenAndroidBluetoothSettings, "OpenAndroidBluetoothSettings" }, // 1069635408
		{ &Z_Construct_UFunction_UForceTubeVRFunctions_Rumble, "Rumble" }, // 4139641232
		{ &Z_Construct_UFunction_UForceTubeVRFunctions_SetActiveResearch, "SetActiveResearch" }, // 3270614952
		{ &Z_Construct_UFunction_UForceTubeVRFunctions_Shot, "Shot" }, // 718223726
		{ &Z_Construct_UFunction_UForceTubeVRFunctions_TempoToKickPower, "TempoToKickPower" }, // 4130625135
	};
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(UForceTubeVRFunctions, 3973959475);
