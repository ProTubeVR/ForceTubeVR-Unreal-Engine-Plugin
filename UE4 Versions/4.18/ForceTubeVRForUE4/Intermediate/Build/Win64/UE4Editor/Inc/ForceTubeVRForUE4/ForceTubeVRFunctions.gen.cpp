...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_UForceTubeVRFunctions_OpenAndroidBluetoothSettings()
	{
		...
		if (!ReturnFunction)
		{
			auto NewProp_isInVR_SetBit = [](void* Obj){ ((ForceTubeVRFunctions_eventOpenAndroidBluetoothSettings_Parms*)Obj)->isInVR = 1; };
			static const UE4CodeGen_Private::FBoolPropertyParams NewProp_isInVR = { UE4CodeGen_Private::EPropertyClass::Bool, "isInVR", RF_Public|RF_Transient|RF_MarkAsNative, 0x0010000000000080, 1, nullptr, sizeof(bool), UE4CodeGen_Private::ENativeBool::Native, sizeof(ForceTubeVRFunctions_eventOpenAndroidBluetoothSettings_Parms), &UE4CodeGen_Private::TBoolSetBitWrapper<decltype(NewProp_isInVR_SetBit)>::SetBit, METADATA_PARAMS(nullptr, 0) };
			static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[] = {
				(const UE4CodeGen_Private::FPropertyParamsBase*)&NewProp_isInVR,
			};
#if WITH_METADATA
			static const UE4CodeGen_Private::FMetaDataPairParam Function_MetaDataParams[] = {
				{ "Category", "ForceTubeVR" },
...
#endif
			static const UE4CodeGen_Private::FFunctionParams FuncParams = { (UObject*(*)())Z_Construct_UClass_UForceTubeVRFunctions, "OpenAndroidBluetoothSettings", RF_Public|RF_Transient|RF_MarkAsNative, nullptr, (EFunctionFlags)0x04022401, sizeof(ForceTubeVRFunctions_eventOpenAndroidBluetoothSettings_Parms), PropPointers, ARRAY_COUNT(PropPointers), 0, 0, METADATA_PARAMS(Function_MetaDataParams, ARRAY_COUNT(Function_MetaDataParams)) };
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, FuncParams);
		}
		return ReturnFunction;
	}
	...
	UClass* Z_Construct_UClass_UForceTubeVRFunctions()
	{
		...
		if (!OuterClass)
		{
			...
			static const FClassFunctionLinkInfo FuncInfo[] = {
				{ &Z_Construct_UFunction_UForceTubeVRFunctions_GetBatteryLevel, "GetBatteryLevel" }, // 3690100970
				{ &Z_Construct_UFunction_UForceTubeVRFunctions_Kick, "Kick" }, // 1625811548
				{ &Z_Construct_UFunction_UForceTubeVRFunctions_OpenAndroidBluetoothSettings, "OpenAndroidBluetoothSettings" }, // 3418917731
				{ &Z_Construct_UFunction_UForceTubeVRFunctions_Rumble, "Rumble" }, // 1466913587
				{ &Z_Construct_UFunction_UForceTubeVRFunctions_SetActiveResearch, "SetActiveResearch" }, // 2534776992
				{ &Z_Construct_UFunction_UForceTubeVRFunctions_Shot, "Shot" }, // 526840677
	...
	IMPLEMENT_CLASS(UForceTubeVRFunctions, 406806105);
